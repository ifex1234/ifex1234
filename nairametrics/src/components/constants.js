...
export const navLinks = [ 'Home','Business', 'Economy', 'Exclusive', 
'Financial' , 'Industries', 'Lifestyle' , 'Markets', 'Opinions'
]
...
export const Economy = [
    'Nairalytics', 'Macros', 'Research Analysis', 'Budget', 'Public Debt'
];
export const Financial_Literacy = ['Career tips', 'Personal Finance'];
export const Lifestyle =['Billonaire Watch'];
export const Opinions = ['Blurb', 'Op-Eds']